...
function rd_duplicate_post_link($actions, $post)
{
    ...
    $actions['duplicate'] = '<a href="' . $url . '" title="Dupliquer ce post" rel="permalink">Dupliquer</a>';
...
function rd_duplicate_post_as_draft()
{
    ...
    if (empty($_GET['post'])) {
        wp_die('Pas de post sélectionné à dupliquer');
    }
    ...
    if ($post) {
        ...
        wp_die('La duplication a échoué car de post original trouvé');
    }
}
...
function rudr_duplication_admin_notice()
{
    ...
    if (isset($_GET['saved']) && 'post_duplication_created' == $_GET['saved']) {
        ...
        echo '<div class="notice notice-success is-dismissible"><p>La copie du post a été créée</p></div>';
    }
}