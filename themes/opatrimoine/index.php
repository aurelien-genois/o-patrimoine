...
<div class="container mx-auto px-5 md:px-8 lg:px-12 xl:px-18 2xl:px-28mx-auto">
    ...
    <section>
        ...
        <a class="link" href="#"><?= (get_field('home_visit_of_the_day_link_text', get_the_ID()) ?? 'Les autres visites du jour') ?></a>
    </section>
    ...
    <section>
        ...
        <a class="link" href="#"><?= (get_field('home_location_highlight_link_text', get_the_ID()) ?? 'Les autres visites du lieu') ?></a>
    </section>
