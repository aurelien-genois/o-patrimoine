...
<nav id="navMenu">
    <div id="mobileMenu" class="relative">
        <div id="menuClose" class="absolute top-0 right-0 z-20 flex items-center justify-center h-7 w-7 p-0.5 text-white font-bold hover:border hover:rounded-3xl hover:border-white cursor-pointer">
            << /div>
                            ...
                            ?>
                                ...
                                <li class="menu-item relative uppercase text-sm lg:text-base md:mx-4 text-white md:text-main <?= (!empty($subMenuItems)) ? 'menu-item-has-children' : '' ?>">
                                    ...
                                    <?php if (!empty($subMenuItems)) : ?>
                                        <ul class="sub-menu">
                                            <li class="sub-menu-back text-base cursor-pointer p-0.5 flex items-center justify-center md:hidden h-7 w-7 font-bold hover:border hover:rounded-3xl hover:border-white">
                                                << /li>
